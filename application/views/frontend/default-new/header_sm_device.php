    ...
    <div class="offcanvas-body p-0">
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
          ...
          <!-- Same academy sections as the desktop bar, so the phone menu is
               not a smaller site than the desktop one. -->
          <?php foreach (array(
                'en/programs'           => 'Programs',
                'en/paths'              => 'Learning Paths',
                'en/hospitality-topics' => 'Hospitality Topics',
                'en/sops'               => 'SOP Resources',
                'en/articles'           => 'Articles',
                'en/hotels'             => 'For Hotels',
                'en/verify'             => 'Verify a certificate',
            ) as $academy_url => $academy_label): ?>
            <li class="bg-light">
              <a href="<?php echo base_url($academy_url); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500"><i class="fas fa-angle-right me-2"></i> <?php echo site_phrase($academy_label); ?></a>
            </li>
          <?php endforeach; ?>
          ...
          <?php elseif($user_login): ?>
            <li class="bg-light"><a class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500" href="<?php echo site_url('hkp'); ?>" data-hkp-menu><i class="fas fa-th-large me-2"></i><?php echo site_phrase('knowledge_performance'); ?></a></li>
