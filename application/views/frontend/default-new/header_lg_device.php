...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <!-- The public academy sections. Without these the signed-out chrome
           dead-ends at the catalogue and a visitor who lands on the login
           page has no way back into the site. -->
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-nowrap" href="javascript:;" id="navbarDropdownAcademy">
            <span><?php echo site_phrase('Academy'); ?><i class="fas fa-angle-down ms-2"></i></span>
          </a>
          <ul class="navbarHover">
            <li><a href="<?php echo base_url('en/programs'); ?>"><?php echo site_phrase('Programs'); ?></a></li>
            <li><a href="<?php echo base_url('en/paths'); ?>"><?php echo site_phrase('Learning Paths'); ?></a></li>
            <li><a href="<?php echo base_url('en/hospitality-topics'); ?>"><?php echo site_phrase('Hospitality Topics'); ?></a></li>
            <li><a href="<?php echo base_url('en/sops'); ?>"><?php echo site_phrase('SOP Resources'); ?></a></li>
            <li><a href="<?php echo base_url('en/articles'); ?>"><?php echo site_phrase('Articles'); ?></a></li>
            <li><a href="<?php echo base_url('en/hotels'); ?>"><?php echo site_phrase('For Hotels'); ?></a></li>
            <li><a href="<?php echo base_url('en/verify'); ?>"><?php echo site_phrase('Verify a certificate'); ?></a></li>
          </ul>
        </li>
      </ul>
