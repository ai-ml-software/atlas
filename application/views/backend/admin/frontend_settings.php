        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="scrollable-tab-section" id="basicwizard">
                    ...
                    <div class="scrollable-tab" style="height: 50px; overflow-y: hidden;">
                        ...
                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3" style="width: fit-content;">
                            ...
                            <li class="nav-item">
                                <a href="#altus_chrome" data-toggle="tab" aria-expanded="false" class="nav-link rounded-0 py-2">
                                    <i class="mdi mdi-view-compact d-lg-none d-block mr-1"></i>
                                    <span class="d-none d-lg-block"><?php echo get_phrase('Header and Footer'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <!-- Altus site chrome: the wording in the utility rail and the
                         footer. Previously hardcoded in the layout, so changing the
                         address was a deploy. Leave a field empty to use the shipped
                         default; see application/helpers/ha_chrome_helper.php. -->
                    <div class="tab-pane" id="altus_chrome">
                        <h4 class="mb-3 header-title"><?php echo get_phrase('Site header and footer'); ?></h4>
                        <form action="<?php echo site_url('admin/frontend_settings'); ?>" method="post">
                            <p class="text-muted mb-4">
                                <?php echo get_phrase('Leave a field empty to use the built-in wording. Social links stay hidden until a URL is entered.'); ?>
                            </p>

                            <div class="form-group">
                                <label for="ha_rail_note_en"><?php echo get_phrase('Top bar note'); ?> (EN)</label>
                                <input type="text" class="form-control" name="ha_rail_note_en" id="ha_rail_note_en"
                                       value="<?php echo html_escape(get_frontend_settings('ha_rail_note_en')); ?>">
                            </div>
                            <div class="form-group">
                                <label for="ha_rail_note_ar"><?php echo get_phrase('Top bar note'); ?> (AR)</label>
                                <input type="text" class="form-control" dir="rtl" name="ha_rail_note_ar" id="ha_rail_note_ar"
                                       value="<?php echo html_escape(get_frontend_settings('ha_rail_note_ar')); ?>">
                            </div>

                            <div class="form-group">
                                <label for="ha_footer_statement_en"><?php echo get_phrase('Footer statement'); ?> (EN)</label>
                                <input type="text" class="form-control" name="ha_footer_statement_en" id="ha_footer_statement_en"
                                       value="<?php echo html_escape(get_frontend_settings('ha_footer_statement_en')); ?>">
                            </div>
                            <div class="form-group">
                                <label for="ha_footer_statement_ar"><?php echo get_phrase('Footer statement'); ?> (AR)</label>
                                <input type="text" class="form-control" dir="rtl" name="ha_footer_statement_ar" id="ha_footer_statement_ar"
                                       value="<?php echo html_escape(get_frontend_settings('ha_footer_statement_ar')); ?>">
                            </div>

                            <div class="form-group">
                                <label for="ha_contact_address_en"><?php echo get_phrase('Address'); ?> (EN)</label>
                                <textarea class="form-control" rows="2" name="ha_contact_address_en" id="ha_contact_address_en"><?php echo html_escape(get_frontend_settings('ha_contact_address_en')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="ha_contact_address_ar"><?php echo get_phrase('Address'); ?> (AR)</label>
                                <textarea class="form-control" dir="rtl" rows="2" name="ha_contact_address_ar" id="ha_contact_address_ar"><?php echo html_escape(get_frontend_settings('ha_contact_address_ar')); ?></textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="ha_contact_phone"><?php echo get_phrase('Phone'); ?></label>
                                    <input type="text" class="form-control" name="ha_contact_phone" id="ha_contact_phone"
                                           value="<?php echo html_escape(get_frontend_settings('ha_contact_phone')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                foreach ($ha_networks as $ha_k => $ha_label): ?>
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="url" class="form-control" name="ha_social_<?php echo $ha_k; ?>"
                                               id="ha_social_<?php echo $ha_k; ?>"
                                               value="<?php echo html_escape(get_frontend_settings('ha_social_' . $ha_k)); ?>"
                                               placeholder="https://">
                                    </div>
                                <?php endforeach; ?>
                            </div>
