                    ...
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <div class="ft2-nav-wrap">
                            ...
                            <ul class="ft2-nav-group">
                                ...
                                <!-- The public academy sections, so the footer
                                     is the same map on both halves of the site. -->
                                <li> <a class="ft2-nav-link" href="<?php echo base_url('en/programs'); ?>"><?php echo site_phrase('Programs'); ?></a></li>
                                <li> <a class="ft2-nav-link" href="<?php echo base_url('en/sops'); ?>"><?php echo site_phrase('SOP Resources'); ?></a></li>
                                <li> <a class="ft2-nav-link" href="<?php echo base_url('en/hotels'); ?>"><?php echo site_phrase('For Hotels'); ?></a></li>
                                <li> <a class="ft2-nav-link" href="<?php echo base_url('en/verify'); ?>"><?php echo site_phrase('Verify a certificate'); ?></a></li>
                                <li> <a class="ft2-nav-link" href="<?php echo site_url('home/posts'); ?>"><?php echo site_phrase('community'); ?></a></li>                                
