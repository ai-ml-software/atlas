                                        ...
                                        <div class="my-course-1-last">
                                            <div class="icon-img d-grid">
                                                ...
                                                <?php if($enrolment['expiry_date'] > 0 && $enrolment['expiry_date'] < time()): ?>
                                                    <span class="text-12px text-start mt-2"><?php echo get_phrase('Expired') ?> - <b style="color: var(--bs-code-color);"><?php echo date('d M Y, H:i A', (int) $enrolment['expiry_date']); ?></b></span>
                                                <?php else: ?>
                                                    <?php
                                                    // expiry_date is a varchar and an empty string is a
                                                    // realistic value for a lifetime enrolment. In PHP 8
                                                    // '' == 0 is false, so an empty value used to fall
                                                    // through to date() and take the page down with a
                                                    // TypeError. Compare as an integer instead.
                                                    ?>
                                                    <?php if((int) $enrolment['expiry_date'] === 0): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="text-12px text-start mt-2"><?php echo get_phrase('Expiration On') ?> - <b><?php echo date('d M Y, H:i A', (int) $enrolment['expiry_date']); ?></b></span>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </div>
